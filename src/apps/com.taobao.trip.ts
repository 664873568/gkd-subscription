      ...
      rules: [
        {
          key: 0,
          matches: [
            '[getChild(2).getChild(1).text~="剩余 [0-9]+s"] -n * @[text="免看本次广告"][vid="sdm_myoffer_inctask_cta"]',
          ],
        },
        {
          key: 1,
          matches: [
            '[getChild(2).getChild(1).text~="剩余 [0-9]+s"] -n * @[text="点此领取奖励"][vid="sdm_myoffer_inctask_cta"][clickable=true]',
          ],
        },
        {
          key: 2,
