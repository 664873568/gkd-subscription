  ...
  groups: [
    ...
    //https://u.jr.jd.com/uc-fe-wxgrowing/cloudpig/index/
    {
      ...
      rules: [
        {
          matches: [
            '[id="J_ui-div"] > [id="app"] > View > View > View > [text="createFood"] + @TextView[clickable=true] + [text="10g"] + [text="createAwardSignfull"]',
          ],
          activityIds: ['.bm.common.web.ui.WebActivity'],
        },
      ],
      ...
      rules: [
        {
          ...
          actionDelay: 1000,
          matches: [
            'View[getChild(1).text!~="领.*|.*话费.*|玩.*|.*订单|.*卡|.*券.*|去看.*"] > @[text="去完成"][clickable=true]',
          ],
          activityIds: ['.bm.common.web.ui.WebActivity'],
        },
        {
    ...
    //查看精彩内容10s
    {
      ...
      rules: [
        ...
        },
        {
          ...
          actionDelay: 5000,
          matches: [
            '@Button[clickable=true] < [vid="common_webview_navbar_left"] + [text="商品详情"] + ImageView + [vid="common_webview_navbar_right"]',
          ],
          activityIds: ['.bm.common.web.ui.WebActivity'],
        },
        {
      ...
      rules: [
        {
          key: 0,
          matches: [
            '[id="taskFloorId"] > [getChild(0).text!~="额外.*|.*话费|.*一笔.*订单.*"] > @[text="去完成"][clickable=true]',
          ],
          activityIds: ['.bm.common.web.ui.WebActivity'],
        },
        {
      ...
      rules: [
        {
          ...
          excludeMatches: [
            '[id="taskFloorId"] > [getChild(0).text!~="额外.*|.*话费|.*一笔.*订单.*"] > @[text="去完成"][clickable=true]',
            'View > View > [text="去领取"] + @[text="close1_6723ec4261"][clickable=true]',
          ],
          matches: [
      ...
      rules: [
        {
          key: 0,
          matches: [
            '[id="headFloor"] > View > [getChild(1).getChild(0).text="（可抽0次）"] -n View > @[text="去提现"]',
          ],
        },
        {
          key: 1,
      ...
      rules: [
        {
          ...
          actionDelay: 1000,
          matches: [
            '@[text="浏览App赚豆"][clickable=true] <n * +n * [text="去YY直播领福利"]',
          ],
        },
        {
          preKeys: [0],
          ...
          actionDelay: 1000,
          matches: [
            '@View[clickable=true] > [getChild(0).getChild(0).text!~="去移动领话费"] + [text="去完成"]',
          ],
        },
      ],
    },
      ...
      rules: [
        {
          ...
          matches: [
            '@[text="做任务赚豆"][clickable=true] <n * +n * [text^="京豆捕鱼"]',
          ],
        },
        {
          preKeys: [0],
          ...
          actionDelay: 1000,
          matches: [
            '@View[clickable=true] > [getChild(0).getChild(0).text!~="体验.*|消灭.*|完成.*|.*权益|加赠.*|开通.*|分享.*|京豆.*|成功.*"] + [text="去完成"]',
          ],
        },
        {
          preKeys: [0, 1],
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          matches: [
            '@View[clickable=true] > [getChild(0).getChild(0).text="成功喂猪或浇水1次"] + [text="去完成"]',
          ],
        },
        {
          preKeys: [0, 1],
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          key: 1,
          excludeMatches: [
            '@View[clickable=true] > [getChild(0).getChild(0).text!~="体验.*|消灭.*|完成.*|.*权益|加赠.*|开通.*|分享.*|京豆.*"] + [text="去完成"]',
          ],
          matches: [
            '@View[clickable=true] > [getChild(0).getChild(0).text="京豆捕鱼｜消耗10%能量值"] + [text="去完成"]',
          ],
          activityIds: ['.bm.common.web.ui.WebActivity'],
        },
        {
      ...
      rules: [
        {
          ...
          actionDelay: 3000,
          matches: [
            'View[childCount=5] +n View > @View[clickable=true] > [text="可领取"] + [desc="桌面小组件"]',
          ],
        },
        {
          preKeys: [0],
      ...
      rules: [
        {
          ...
          matches: [
            '[getChild(1).text!~="打.*|.*体验.*|完成.*|去.*|通过.*|开炮.*"] > @[desc="去完成"][clickable=true] > [text="去完成"]',
          ],
          activityIds: ['.bm.common.web.ui.WebActivity'],
        },
        {
      ...
      rules: [
        {
          ...
          matches: [
            '[getChild(1).text~="开炮击杀任意一条鱼"] > @[desc="去完成"][clickable=true] > [text="去完成"]',
          ],
          activityIds: ['.bm.common.web.ui.WebActivity'],
        },
        {
    ...
    //做任务赚京豆
    {
      ...
      rules: [
        ...
        {
          key: 2,
          excludeMatches: ['[text="正在浏览"]'],
          actionDelay: 5000,
          matches: [
            '@Button[clickable=true] < [vid="common_webview_navbar_left"] + TextView + ImageView + [vid="common_webview_navbar_right"]',
          ],
        },
        {
          key: 3,
    ...
    //做任务赚金币
    {
      ...
      rules: [
        ...
        },
        {
          ...
          actionDelay: 5000,
          anyMatches: [
            '@Button[clickable=true] < [vid="common_webview_navbar_left"] + [text="正在跳转..."] + ImageView + [vid="common_webview_navbar_right"]',
            '@Button[clickable=true] < [vid="common_webview_navbar_left"] + [text="商品详情"] + ImageView + [vid="common_webview_navbar_right"]',
