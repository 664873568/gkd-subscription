    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          key: 2,
          matches: [
            '[id="J_GAME_MARKET_POP_SDK"] >n View > @[text="领取"][clickable=true]',
          ],
        },
      ],
    },
      ...
      rules: [
        {
          ...
          actionDelay: 1000,
          matches: [
            '[id="app"] > View > [getChild(0).name$="View"] + [getChild(0).getChild(0).desc="桌面小组件"] +n View > View > @View[clickable=true] + [text="可领取"]',
          ],
        },
        {
          preKeys: [0],
