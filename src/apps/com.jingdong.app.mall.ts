...
export default defineGkdApp({
  ...
  groups: [
    ...
    //天天签到抽奖
    //https://prodev.m.jd.com/mall/active/4WMAPf9VCBdEE8Rva1AVEPH7CBbj/index.html
    {
      key: 40,
      name: '天天签到抽奖',
      matchRoot: true,
      ...
      rules: [
        {
          ...
          anyMatches: [
            ...
            //'@[text="去完成"][clickable=true] -n [text^="添加“9.9包邮”桌面组件"]',
            ...
            '@[text="去完成"][clickable=true] -n [text^="天天竞猜领100京豆"]',
