    ...
    //天天砸金蛋
    {
      ...
      rules: [
        ...
        },
        {
          ...
          actionDelay: 2000,
          matches: [
            'View > View > @[text="去完成"][clickable=true]',
          ],
          activityIds: [
            '.WebActivity',
        ...
        },
        {
          ...
          key: 5,
          actionDelay: 15000,
          matches: ['ViewGroup > LinearLayout > @TextView[text=""][clickable=true] + ImageView'],//逛新品频道 每天领红包-逛排行榜最高得99豆-逛超级明星抽8888红包-逛拍卖领京豆
        ...
        },
        {
          ...
          key: 6,
          actionDelay: 15000,
          matches: ['ViewGroup + ViewGroup + @ViewGroup[clickable=true] > ImageView'],//健康金限时领
          activityIds: ['com.jingdong.common.jdreactFramework.activities.JDReactNativeCommonActivity'],
        },
        {
          preKeys: [1],
          key: 7,
          matches: ['ViewGroup[childCount=2] > ViewGroup + ViewGroup[childCount=2] > @ViewGroup[clickable=true] > ImageView'],//健康金限时领
          activityIds: ['com.jingdong.common.jdreactFramework.activities.JDReactNativeCommonActivity'],
        },
        {
          preKeys: [1],
          key: 8,
          actionDelay: 15000,
          matches: ['[text="推荐"] <n @ViewGroup[clickable=true] < * + * [text="试用领取"]'],
          activityIds: ['.MainFrameActivity'],
        },
        {
          preKeys: [1,8],
          key: 9,
          matches: ['[text="9.9包邮"] <n @ViewGroup[clickable=true] < * - * [text="推荐"]'],
          activityIds: ['.MainFrameActivity'],
        },
        {
          key: 10,
        ...
        },
        {
          preKeys: [10],
          key: 11,
          matches: ['@[desc="关闭弹窗"][clickable=true] + View > View > View + TextView[clickable=true]'],
          activityIds: [
            '.WebActivity',
            '.MainFrameActivity',
          ],
