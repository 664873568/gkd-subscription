  ...
  groups: [
    ...
    },
    {
      ...
      rules: [
        {
          action: 'back',
          matches: ['@ImageButton <<n * [text="01a5e1e730630a185cbd7e5910f29b68.png~tplv-49obo7mizy-75compress"]'],
          activityIds: ['.bullet.ui.BulletContainerActivity'],
        },
      ],
    },
    {
      ...
      rules: [
        {
          action: 'back',
          matches: ['@[desc="返回"][vid="ed-"] <<n * [text="我的保障"][vid="title"]'],
          activityIds: ['.bullet.ui.BulletContainerActivity'],
        },
      ],
    },
    ...
    //充值中心
    {
      ...
      rules: [
        {
          matches: ['@ImageView[index=0][childCount=0] < ViewGroup[index=3][childCount=6]'],
